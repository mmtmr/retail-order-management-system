...
public class Product extends ProductDetails {
    ...
    public Product(String ProID, String ProName, double ProPackingCharge, double ProWeight, ProductType ProCategory) {
        super(ProID, ProName, ProPackingCharge, ProWeight, ProCategory);
    }

    public Product(String ProName, double ProWeight, ProductType ProCategory) {
