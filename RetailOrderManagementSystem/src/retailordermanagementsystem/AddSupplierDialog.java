...
DefaultTableModel model;
    ...
    public AddSupplierDialog(java.awt.Frame parent, boolean modal) {
      ...
      public AddSupplierDialog(java.awt.Frame parent, boolean modal, DefaultTableModel model) {
        super(parent, modal);
        this.model = model;
        initComponents();
    }
    ...
    private void buttonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveActionPerformed
        ...
        try {
            ...
            sup = new Supplier(supname, picfname,piclname, picgender, phone, email, street, city, state, postcode);
            SupList.add(sup);
            ...
            Operation.writeSupplierData(sup);
